...
/*
    ...
    Changes from upstream in this file include:
      - helpers for .NET <-> WebAssembly interaction
...
/*elix22 - 
For interaction between Emscripten <-> .NET runtime , 
Webassembly can't return structures by value to the .NET runtime , so we need to use pointers.
